package com.order.processing.payment.config;
 ...
 * payment-service, ensuring B3 trace context is:
 * <ul>
 *   <li><b>Extracted</b> from incoming {@code payment-initiated} Kafka records
 *       (so the consumer continues the trace started by order-service).</li>
 *   <li><b>Injected</b> into outgoing {@code payment-completed} /
 *       {@code payment-failed} Kafka records.</li>
 * </ul>
 *
